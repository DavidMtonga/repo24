      ...
      <div className=" grid xl:grid-cols-3 xl:grid-rows-2 gap-8">
        <div className=" xl:col-span-2 xl:row-start-1 xl:row-end-[-1] relative">
          ...
          <div className="absolute max-w-[470px] sm:ml-16 ml-8 top-[50%] -translate-y-[50%] sm:space-y-4">
            <p className="text-2xl hidden sm:block text-blue-400">
              {" "}
              100% Original Apple headphones
            </p>
            <h2 className=" text-2xl sm:text-4xl md:text-6xl font-bold text-blue-400">
              {" "}
              High quality products!
            </h2>
            <p className=" text-gray-500 text-xl pt-4 sm:pt-8"> Starting At</p>
            <div className="font-medium text-red-600 text-2xl sm:text-4xl pb-4 sm:bp-8">
              {" "}
              $18.39
            </div>
